...
<section class="container" ng-app="cartApp">
    <div ng-controller="cartCtrl" ng-init="initCartId('${cartId}')">
        <div>
            <a class="btn btn-danger pull-left" ng-click="clearCart()"> <span class="glyphicon glyphicon-removesign"></
                    span> Clear Cart </a> <a href="<spring:url value="/checkout?cartId=${cartId}"/>"
        ...
        <table class="table table-hover">
            ...
            <tr ng-repeat="item in cart.cartItems">
                ...
                <td><a href="#" class="label labeldanger" ng-click="removeFromCart(item.product.productId)"> <span
