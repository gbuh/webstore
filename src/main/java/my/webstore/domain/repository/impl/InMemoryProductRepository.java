...
public class InMemoryProductRepository implements ProductRepository {
    ...
    public void addProduct(Product product) {
        String SQL =
                "INSERT INTO PRODUCTS (ID, NAME, DESCRIPTION, UNIT_PRICE, MANUFACTURER, CATEGORY,"
                        + " CONDITION, UNITS_IN_STOCK, UNITS_IN_ORDER, DISCONTINUED) VALUES (:id, :name,"
                        + " :desc, :price, :manufacturer, :category, :condition, :inStock, :inOrder, :discontinued)";
        Map<String, Object> params = new HashMap<>();
