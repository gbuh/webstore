...
public class InMemoryOrderRepository implements OrderRepository {
    ...
    private long saveShippingDetail(ShippingDetail shippingDetail) {
        ...
        String SQL =
                "INSERT INTO SHIPPING_DETAIL(NAME,SHIPPING_DATE,SHIPPING_ADDRESS_ID) VALUES (:name, :shippingDate, :addressId)";
    ...
    private long saveCustomer(Customer customer) {
        ...
        String SQL =
                "INSERT INTO CUSTOMER(NAME,PHONE_NUMBER,BILLING_ADDRESS_ID) VALUES (:name, :phoneNumber, :addressId)";
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    private long createOrder(Order order) {
        String SQL =
                "INSERT INTO ORDERS(CART_ID,CUSTOMER_ID,SHIPPING_DETAIL_ID) VALUES (:cartId, :customerId, :shippingDetailId)";
        Map<String, Object> params = new HashMap<String, Object>();
