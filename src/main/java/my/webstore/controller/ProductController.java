...
import my.webstore.exception.NoProductsFoundUnderCategoryException;
...
public class ProductController {
    ...
    /*
     * public String getAddNewProductForm(Model model) { Product newProduct = new Product();
        ...
        if (productImage != null && !productImage.isEmpty()) {
            try {
                productImage.transferTo(new File(
                        rootDirectory + "resources\\img" + new Product().getProductId() + ".png"));
            } catch (Exception e) {
